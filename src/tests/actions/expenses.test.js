...
import { addExpense, editExpense, removeExpense, setExpenses, startSetExpenses, startRemoveExpenses, startEditExpense } from '../../actions/expenses';
...
test('should add expense to database and store', (done) => {
    const store = createMockSrote(defaultAuthState);
    const expenseData = {
        description: 'Mouse',
        amount: 3000,
